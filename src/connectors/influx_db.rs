        ...
        if vec!["bf1", "bfv", "bf4"].contains(&frontend_game_name) {
            points.append(&mut vec![
                build_data_point(
                    ...
                    platform,
                    "spectatorAmount",
                    &value.amounts.spectator_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    platform,
                    "diceServerAmount",
                    &value.amounts.dice_server_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    platform,
                    "diceSoldierAmount",
                    &value.amounts.dice_soldier_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    platform,
                    "diceQueueAmount",
                    &value.amounts.dice_queue_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    platform,
                    "diceSpectatorAmount",
                    &value.amounts.dice_spectator_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    &value.amounts.community_server_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    &value.amounts.community_soldier_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    &value.amounts.community_queue_amount,
                )?,
                build_data_point(
                    frontend_game_name,
                    "amounts",
                    ...
                    &value.amounts.community_spectator_amount,
                )?,
            ]);
        }
